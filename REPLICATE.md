...
- Previous location: `best/consequentialist`. Earlier history remains in `alejoacelas/best` at `22ff301` and the local migration Git bundle.

Agent session 01a072fe-84d6-73f3-b37e-3bb912088c38 · Commits 4d8653e

## Organize writing by subject

The human wanted the writing collection grouped into AI, software and life.

- Moved `writing/consequentialist` to `writing/life/consequentialism`, preserving repository history and privacy settings.
